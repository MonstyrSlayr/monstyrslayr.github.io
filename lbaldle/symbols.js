class Symbol
{
    constructor (name, rarity, coin, symbolCount, symbolApp, itemApp, image, achieveName = "", achieveDesc = "No unlockable achievement for this symbol.")
    {
        this.name = name;
        this.rarity = rarity;
        this.coin = coin;
...
[
    ...
    new Symbol("Bronze Arrow", RARITY.UNCOMMON, 0, 1, 1, 1, "bronze_arrow.png", "NEW_ACHIEVEMENT_2_18", "Have 3 or more Bronze Arrows point to 0 symbols during a spin."),
    ...
    new Symbol("Chemical Seven", RARITY.UNCOMMON, 0, 0, 2, 4, "chemical_seven.png", "NEW_ACHIEVEMENT_2_26", "Destroy 3 or more Chemical Sevens during a spin."),
    ...
    new Symbol("Eldritch Creature", RARITY.VERYRARE, 4, 18, 3, 2, "eldritch_beast.png", "NEW_ACHIEVEMENT_3_19", "Add a symbol then immediately remove it to increase the value of an Eldritch Creature."),
    ...
    new Symbol("Five-Sided Die", RARITY.UNCOMMON, 0, 0, 1, 3, "d5.png", "NEW_ACHIEVEMENT_3_10", "Have a Five-Sided Die destroy 2 or more Gamblers during a spin."),
    ...
    new Symbol("Frozen Fossil", RARITY.RARE, 0, 10, 0, 1, "frozen_fossil.png", "NEW_ACHIEVEMENT_3_25", "Remove a symbol to make a Frozen Fossil be destroyed faster."),
    ...
    new Symbol("General Zaroff", RARITY.RARE, 1, 26, 2, 3, "general_zaroff.png", "NEW_ACHIEVEMENT_2_15", "Have General Zaroff destroy 1924 humans across all games."),
    ...
    new Symbol("Golden Arrow", RARITY.VERYRARE, 0, 1, 1, 1, "golden_arrow.png", "NEW_ACHIEVEMENT_3_28", "Have 3 or more Golden Arrows point to 0 symbols during a spin."),
    new Symbol("Golden Egg", RARITY.RARE, 4, 0, 5, 3, "golden_egg.png", "NEW_ACHIEVEMENT_3_29", "Have a Golden Egg adjacent to an Egg."),
    ...
    new Symbol("Hex of Destruction", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_destruction.png", "NEW_ACHIEVEMENT_4_14", "Have a Hex of Destruction trigger 3 spins in a row."),
    new Symbol("Hex of Draining", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_draining.png", "NEW_ACHIEVEMENT_2_23", "Have a Hex of Draining increase the value of a symbol."),
    new Symbol("Hex of Emptiness", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_emptiness.png", "NEW_ACHIEVEMENT_4_5", "Have a Hex of Emptiness trigger 3 spins in a row."),
    new Symbol("Hex of Hoarding", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_hoarding.png", "NEW_ACHIEVEMENT_5_8", "Have a Hex of Hoarding trigger 3 spins in a row."),
    new Symbol("Hex of Midas", RARITY.UNCOMMON, 3, 1, 4, 3, "hex_of_midas.png", "NEW_ACHIEVEMENT_4_7", "Have a Hex of Midas trigger 3 spins in a row."),
    new Symbol("Hex of Tedium", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_tedium.png", "NEW_ACHIEVEMENT_3_5", "Add a Hex of Tedium from the choice after destroying a Tedium Capsule."),
    new Symbol("Hex of Thievery", RARITY.UNCOMMON, 3, 0, 4, 2, "hex_of_thievery.png", "NEW_ACHIEVEMENT_4_9", "Have a Hex of Thievery trigger 3 spins in a row."),
    ...
    new Symbol("Matryoshka Doll", RARITY.UNCOMMON, 0, 1, 0, 1, "matryoshka_doll_1.png", "NEW_ACHIEVEMENT_4_24", "Destroy a Matryoshka Doll before it destroys itself."),
    ...
    new Symbol("Mrs. Fruit", RARITY.RARE, 2, 6, 2, 3, "mrs_fruit.png", "NEW_ACHIEVEMENT_5_3", "Have Mrs. Fruit destroy 20 or more symbols before rent payment #12 is due."),
    ...
    new Symbol("Silver Arrow", RARITY.RARE, 0, 1, 1, 1, "silver_arrow.png", "NEW_ACHIEVEMENT_5_31", "Have 3 or more Silver Arrows point to 0 symbols during a spin."),
    ...
    new Symbol("Three-Sided Die", RARITY.COMMON, 0, 0, 1, 3, "d3.png", "NEW_ACHIEVEMENT_3_9", "Have a Three-Sided Die destroy 2 or more Gamblers during a spin."),
