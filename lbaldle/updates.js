...
[
    ...
    new Update("The Daily", ["The Daily is here, along with a myriad of quality of life changes.", "Only 8 guesses now: Since the game has gotten much easier, I've decided to reduce the amount of guesses from 10 to 8. Let me know your feedback.", "Achievement Percentage: A new column to reduce duplicate symbols. Gets the achievement percentage straight from Steam.", "Symbol Info: Hover over or tap on a symbol to see its info!", "Symbol Preview: The symbol will show up under the input box as you type it. Use this to match the symbol's info to your other guesses.", "And as always, be sure to report any bugs."]),
]
