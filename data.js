...
export const HOME = isLiveServer() ? "http://127.0.0.1:5500/" : "https://monstyrslayr.github.io/";

export const FILTERTYPE = Object.freeze({
    LANGUAGE: "Language", // python, html, etc.
    DOMAIN: "Domain", // deltarune, juggling club, etc.
    WEBSITE: "Host", // github, youtube, etc.
    SCHOOL: "School" // masters, rit, etc.
});
...
const masters = new Filter(FILTERTYPE.SCHOOL, "The Masters School");
const rit = new Filter(FILTERTYPE.SCHOOL, "RIT");

const python = new Filter(FILTERTYPE.LANGUAGE, "Python");
const html = new Filter(FILTERTYPE.LANGUAGE, "HTML");
const css = new Filter(FILTERTYPE.LANGUAGE, "CSS");
const javascript = new Filter(FILTERTYPE.LANGUAGE, "JavaScript");
const gml = new Filter(FILTERTYPE.LANGUAGE, "GameMaker Language");

const juggling = new Filter(FILTERTYPE.DOMAIN, "Juggling Club");
const deltarune = new Filter(FILTERTYPE.DOMAIN, "UNDERTALE / DELTARUNE");
const brawlstars = new Filter(FILTERTYPE.DOMAIN, "Brawl Stars");
const rhythmdoctor = new Filter(FILTERTYPE.DOMAIN, "Rhythm Doctor");
const msm = new Filter(FILTERTYPE.DOMAIN, "My Singing Monsters");
const lbal = new Filter(FILTERTYPE.DOMAIN, "Luck be a Landlord");
const badapple = new Filter(FILTERTYPE.DOMAIN, "Bad Apple");
...
class Project
{
    constructor(title, description, image, link, date, isWIP = false, filters = [])
    {
        this.title = title;
...
const lbaldle = new Project(
    ...
    HOME + "img/LBALDLE.png",
    "https://monstyrslayr.github.io/lbaldle/",
    new Date("09/22/2024"),
    false,
    [html, css, javascript, lbal]
);
...
const tigerGoodbuy = new Project(
    ...
    HOME + "img/tigerGoodbuy.png",
    "https://adeseyn.github.io/tigergoodbuy/",
    new Date("12/09/2024"),
    false,
    [rit, html, css, javascript]
);
...
const lbalBadApple = new Project(
    ...
    HOME + "img/lbalBadApple.png",
    "https://github.com/MonstyrSlayr/lbalBadApple",
    new Date("05/27/2025"),
    false,
    [python, lbal, badapple, github, youtube]
);
...
const deltaruneMotifs = new Project(
    ...
    new Date("12/20/2025"),
    true,
    [html, css, javascript, deltarune, github, youtube]
);
...
const bossFightBadApple = new Project(
    ...
    HOME + "img/rdBapple.png",
    "https://youtu.be/cyWGuhD37eQ",
    new Date("1/14/2026"),
    false,
    [python, rhythmdoctor, badapple, youtube]
);
