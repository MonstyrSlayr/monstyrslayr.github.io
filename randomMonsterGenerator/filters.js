...
async function createFilters()
{
    ...
    for (let i = 1; i < 6; i++)
    {
        elementCountConditionals.push(new Conditional((i == 1) ? "1 Element" : i + " Elements", elementCountCheckboxDiv, function(monster = Monster) { return monster.elements.size == i} ));
    }
